...
<div class="max-w-xl mx-auto mt-10 bg-white shadow-md rounded p-6">
    <h2 class="text-2xl font-semibold mb-6 text-center text-gray-700">Ajouter une Année Scolaire</h2>
    ...
    <form action="{{ route('annees.store') }}" method="POST" class="space-y-6">
        ...
        <!-- Libelle -->
        <div>
            <label for="libelle" class="block text-sm font-medium text-gray-700">Libellé de l'année</label>
